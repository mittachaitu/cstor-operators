...
// func IsPendingStatus(bkp *cstorapis.CStorBackup) bool {
// 	if string(bkp.Status) == string(cstorapis.BKPCStorStatusPending) {
// 		return true
// 	}
// 	return false
// }
...
// func IsInProgressStatus(bkp *cstorapis.CStorBackup) bool {
// 	if string(bkp.Status) == string(cstorapis.BKPCStorStatusInProgress) {
// 		return true
// 	}
// 	return false
// }
...
// func IsInitStatus(bkp *cstorapis.CStorBackup) bool {
// 	if string(bkp.Status) == string(cstorapis.BKPCStorStatusInit) {
// 		return true
// 	}
// 	return false
// }
...
// func IsDoneStatus(bkp *cstorapis.CStorBackup) bool {
// 	if string(bkp.Status) == string(cstorapis.BKPCStorStatusDone) {
// 		return true
// 	}
// 	return false
// }
...
// func IsFailedStatus(bkp *cstorapis.CStorBackup) bool {
// 	if string(bkp.Status) == string(cstorapis.BKPCStorStatusFailed) {
// 		return true
// 	}
// 	return false
// }
